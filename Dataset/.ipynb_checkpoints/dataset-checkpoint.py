...
start = time()
handle('/root/CNN-LSTM/Dataset/NSL-KDD/原始数据集/KDDTrain+.csv', '/root/CNN-LSTM/Dataset/NSL-KDD/原始数据集/KDDTest+.csv', 
       '/root/CNN-LSTM/Dataset/NSL-KDD/KDDTrain+_progressed.csv', '/root/CNN-LSTM/Dataset/NSL-KDD/KDDTest+_progressed.csv')
end = time()
print("共耗时：" + str(round((end - start) / 60, 3)) + " min")
